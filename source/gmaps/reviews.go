...
func extractReviewsFromPage(ctx context.Context, page scrapemate.BrowserPage, extraReviews int) ([]DOMReview, error) {
...
func FetchReviewsWithFallback(ctx context.Context, params fetchReviewsParams) (FetchReviewsResponse, []DOMReview, error) {
	...
	if params.page != nil {
		domReviews, domErr := extractReviewsFromPage(ctx, params.page, params.extraReviews)
