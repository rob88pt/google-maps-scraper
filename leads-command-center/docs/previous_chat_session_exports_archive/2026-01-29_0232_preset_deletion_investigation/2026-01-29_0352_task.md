...
- [x] Fix Gallery Preview Regression
  - [x] Add `priority` prop to `LazyImage` to bypass intersection observer
  - [x] Apply `priority` to high-res previews in `LeadDetailPanel`
